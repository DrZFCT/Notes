...
\begin{example}[Langevin diffusion]
    ...
    \end{equation*}
\end{example}
A Markov semigroup is diffusion if the carr\'e du champ satisfies the chain rule.
...
\end{definition}
\begin{remark}
    When the carr\'e du champ satisfies a chain rule, then (2.6.1) and (2.6.2) are equivalent, but in general the first inequality (2.6.1) is strictly stronger.
\end{remark}
...
\section{Operations Preserving Functional Inequalities}

\subsection{Bounded Perturbation}



\subsection{Lipschitz Mapping}


\begin{corollary}[Lipschitz perturbations]
